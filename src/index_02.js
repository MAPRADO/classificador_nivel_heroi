/* Este arquivo é uma segunda opção, com a entrada do "XP" manual através
do Prompt. Fiz esta versão porque na descrição do projeto não fica claro essa
informação. */
...
// Recebendo as entradas via prompt
nome = prompt('Digite um nome para seu herói: ');
xp = prompt('Digite uma pontuação de XP: ');
